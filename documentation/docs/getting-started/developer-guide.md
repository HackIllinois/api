# Developer Guide
This guide details steps on how to set up your local development environment, building, testing and running the API, our release deployment, contributor's guide, and documentation setup. 
...
## Documentation
We use [MkDocs](https://www.mkdocs.org/) for our documentation, and host on [Read The Docs](https://readthedocs.io).
