...
var RegistrationRoutes = arbor.RouteCollection{
	arbor.Route{
		...
		"GET",
		"/registration/",
		alice.New(middleware.AuthMiddleware([]string{"User"}), middleware.IdentificationMiddleware).ThenFunc(GetRegistration).ServeHTTP,
	},
	arbor.Route{
	...
	arbor.Route{
		...
		"POST",
		"/registration/attendee/",
		alice.New(middleware.AuthMiddleware([]string{"User"}), middleware.IdentificationMiddleware).ThenFunc(CreateRegistration).ServeHTTP,
	},
	arbor.Route{
		"UpdateCurrentUserRegistration",
		"PUT",
		"/registration/attendee/",
		alice.New(middleware.AuthMiddleware([]string{"Applicant"}), middleware.IdentificationMiddleware).ThenFunc(UpdateRegistration).ServeHTTP,
	},
	arbor.Route{
		"GetFilteredUserRegistrations",
		"GET",
		"/registration/filter/",
		alice.New(middleware.AuthMiddleware([]string{"Admin"}), middleware.IdentificationMiddleware).ThenFunc(GetRegistration).ServeHTTP,
	},
	arbor.Route{
	...
	arbor.Route{
		...
		"PUT",
		"/registration/mentor/",
		alice.New(middleware.AuthMiddleware([]string{"Mentor"}), middleware.IdentificationMiddleware).ThenFunc(UpdateRegistration).ServeHTTP,
	},
	arbor.Route{
		"GetUserRegistration",
		"GET",
