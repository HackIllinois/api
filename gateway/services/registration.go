...
var RegistrationRoutes = arbor.RouteCollection{
	arbor.Route{
		...
		"GET",
		"/registration/",
		alice.New(middleware.AuthMiddleware([]string{models.UserRole}), middleware.IdentificationMiddleware).ThenFunc(GetRegistration).ServeHTTP,
	},
	arbor.Route{
	...
	arbor.Route{
		...
		"POST",
		"/registration/attendee/",
		alice.New(middleware.AuthMiddleware([]string{models.UserRole}), middleware.IdentificationMiddleware).ThenFunc(CreateRegistration).ServeHTTP,
	},
	arbor.Route{
		"UpdateCurrentUserRegistration",
		"PUT",
		"/registration/attendee/",
		alice.New(middleware.AuthMiddleware([]string{models.ApplicantRole}), middleware.IdentificationMiddleware).ThenFunc(UpdateRegistration).ServeHTTP,
	},
	arbor.Route{
		"GetFilteredUserRegistrations",
		"GET",
		"/registration/filter/",
		alice.New(middleware.AuthMiddleware([]string{models.AdminRole, models.StaffRole}), middleware.IdentificationMiddleware).ThenFunc(GetRegistration).ServeHTTP,
	},
	arbor.Route{
	...
	arbor.Route{
		...
		"PUT",
		"/registration/mentor/",
		alice.New(middleware.AuthMiddleware([]string{models.MentorRole}), middleware.IdentificationMiddleware).ThenFunc(UpdateRegistration).ServeHTTP,
	},
	arbor.Route{
		"GetUserRegistration",
		"GET",
